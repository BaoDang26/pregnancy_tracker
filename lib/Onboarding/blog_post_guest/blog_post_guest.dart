...
class BlogPostGuest extends StatefulWidget {
  const BlogPostGuest({super.key});

  @override
  State<BlogPostGuest> createState() => _BlogPostGuestState();
}

class _BlogPostGuestState extends State<BlogPostGuest> {
